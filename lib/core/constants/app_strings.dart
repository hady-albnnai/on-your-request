...
abstract class AppStrings {
  ...
  // ── الفئات الفرعية للطلبات ───────────────────────────────────────────
  static const Map<String, List<String>> requestSubCategories = {
    'سيارات': ['شراء سيارة', 'استئجار سيارة', 'قطع غيار', 'أخرى'],
    'عقارات': ['شراء عقار', 'استئجار عقار', 'أخرى'],
    'مستعمل': ['أدوات كهربائية', 'غسالات', 'برادات', 'أثاث', 'إلكترونيات', 'ملابس', 'أخرى'],
    'خدمات':  ['سباكة', 'كهرباء', 'نجارة', 'دهان', 'تنظيف', 'بناء', 'نقل وشحن', 'أخرى'],
    'وظائف':  ['دوام كامل', 'دوام جزئي', 'عمل حر', 'تدريب مهني', 'أخرى'],
    'إلكترونيات': ['هواتف', 'أجهزة كمبيوتر', 'تلفزيونات', 'إكسسوار', 'أخرى'],
    'أخرى':   ['أخرى'],
  };

  // ── الفئات الفرعية للعروض ────────────────────────────────────────────
  static const Map<String, List<String>> offerSubCategories = {
    'سيارات': ['بيع سيارة', 'تأجير سيارة', 'قطع غيار', 'أخرى'],
    'عقارات': ['بيع عقار', 'تأجير عقار', 'أخرى'],
    'مستعمل': ['أدوات كهربائية', 'غسالات', 'برادات', 'أثاث', 'إلكترونيات', 'ملابس', 'أخرى'],
    'خدمات':  ['سباكة', 'كهرباء', 'نجارة', 'دهان', 'تنظيف', 'بناء', 'نقل وشحن', 'أخرى'],
    'وظائف':  ['دوام كامل', 'دوام جزئي', 'عمل حر', 'تدريب مهني', 'أخرى'],
    'إلكترونيات': ['هواتف', 'أجهزة كمبيوتر', 'تلفزيونات', 'إكسسوار', 'أخرى'],
  ...
  // ── دالة مساعدة للحصول على الفئات الفرعية حسب النوع ─────────────────
  static List<String> getSubCategories(String type, String category) {
    final map = type == 'offer' ? offerSubCategories : requestSubCategories;
  ...
  // ── البحث ────────────────────────────────────────────────────────────
  static const searchHint     = 'ابحث بالعنوان أو الفئة…';
